...
void s21_print_binary(unsigned int num) {
  for (int i = 31; i >= 0; i--) {
    printf("%d", (num >> i) & 1);
  }
  printf(" ");
...
int main ()
{
  ...
  s21_set_scale(&num1, 30);
  s21_set_scale(&num2, 30);
  ...
  s21_print_binary(num1.bits[3]);
  s21_print_binary(num1.bits[2]);
  s21_print_binary(num1.bits[1]);
  s21_print_binary(num1.bits[0]);
  printf("\n");
  s21_print_binary(num2.bits[3]);
  s21_print_binary(num2.bits[2]);
  s21_print_binary(num2.bits[1]);
  s21_print_binary(num2.bits[0]);
  printf("\n");
